  ...
  @endcan --}}
                @can('edit antrian')
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a data-toggle="modal" data-target="#antrianModalUmum" href="#exampleModalUmum"
                                    class="nav-link"data-backdrop="false">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Poli Umum</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a data-toggle="modal" data-target="#antrianModalKIA" href="#antrianModalKIA"
                                    class="nav-link"data-backdrop="false">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Poli KIA</p>
                                </a>
                            ...
                            <li class="nav-item">
                                <a data-toggle="modal" data-target="#antrianModalGigi" href="#exampleModalGigi"
                                    class="nav-link"data-backdrop="false">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Poli Gigi</p>
                                </a>
                ...
                @guest
                    <li class="nav-item">
                        <a data-toggle="modal" data-target="#modalLogin" href="#modalLogin" class="nav-link"
                            data-backdrop="false">
        ...
        <div class="modal fade" id="exampleModalUmum" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button href="/" type="button" class="btn btn-secondary"
        ...
        <div class="modal fade" id="exampleModalKIA" tabindex="-1" role="dialog"
    ...
    <div class="modal fade" id="exampleModalGigi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="antrianModalUmum" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="antrianModalKIA" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="antrianModalGigi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
